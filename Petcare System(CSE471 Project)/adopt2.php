                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO orderdetails (fname,lname,email,address,pnum,pmethod,pid,quantity,pet) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[address]','$_POST[phone]','$_POST[pmeth]','$ID','$_POST[quan]','bird')";
