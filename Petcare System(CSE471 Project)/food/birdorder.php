        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="bird.php"><i class="fa fa-home"></i>Food Details</a>
                    </li>
					</ul>
            </div>
        </nav>
                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO foodorderdetails (fname,lname,email,address,pnum,pmethod,pid,quantity,pet) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[address]','$_POST[phone]','$_POST[pmeth]','$ID','$_POST[quan]','bird')";
