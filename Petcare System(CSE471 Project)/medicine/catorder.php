                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                            ...
                                            <select name="pmeth" class="form-control" required >
												...
												<option value="EzCash">Cash On Arrival</option>
                                            </select>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO medorderdetails (fname,lname,email,address,pnum,pmethod,pid,quantity,pet) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[address]','$_POST[phone]','$_POST[pmeth]','$ID','$_POST[quan]','cat')";
